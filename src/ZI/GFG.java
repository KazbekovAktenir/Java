...
public class GFG {
    ...
    // this function is usefull for shifting(circular) the
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println("Ваш обычный текст :");
        ...
        System.out.println();
        System.out.println(
                "Ваш зашифрованный текст:"); // printing the cipher
        // text
        for (int i = 0; i < 8; i++)
        ...
        System.out.println();
        System.out.println(
                "Ваш расшифрованный текст :"); // printing the
        // decrypted text
        for (int i = 0; i < 8; i++)
